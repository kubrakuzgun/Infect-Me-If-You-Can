...
namespace WeaponWheel
{
    public class WeaponWheel : MonoBehaviour
    {
        ...
        private float
            ...
            timeToGoToTargetTimeScale = 0.1f; //Adds A Slow Motion Effect when weapon wheel is enabled
        ...
        [Header("Dots & Lines")] [SerializeField]
        private Transform[] dots = new Transform[9];
        ...
        void Update()
        {
            ...
            if (m_WheelEnabled)
                Time.timeScale =
                    Mathf.SmoothDamp(Time.timeScale, targetTimeScale, ref m_TimeV, timeToGoToTargetTimeScale);
            else
